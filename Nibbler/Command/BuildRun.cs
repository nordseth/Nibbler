...
public class BuildRun
{
    ...
    private List<Func<IEnumerable<BuilderLayer>, IImageDestination>> _imageDestinationFactories = new List<Func<IEnumerable<BuilderLayer>, IImageDestination>>();
    ...
    public void AddRegistoryImageDest(string image, string username, string password, bool insecure, bool skipTlsVerify, string dockerConfig)
    {
        _imageDestinationFactories.Add(addedLayers =>
        {
    ...
    public void AddFileImageDest(string file)
    {
        _imageDestinationFactories.Add(addedLayers => new FileImageDestination(file, addedLayers, CreateLogger("FILE")));
    }
    ...
    private async Task WriteImages()
    {
        foreach (var factory in _imageDestinationFactories)
        {
            var pusher = factory(_image.LayersAdded);
