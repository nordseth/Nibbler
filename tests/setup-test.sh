...
docker tag mcr.microsoft.com/dotnet/aspnet:7.0 localhost:5000/dotnet/aspnet:7.0 
docker push localhost:5000/dotnet/aspnet:7.0 
docker image rm localhost:5000/dotnet/aspnet:7.0 
