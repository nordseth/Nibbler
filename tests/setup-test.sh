...
docker tag mcr.microsoft.com/dotnet/aspnet:8.0 localhost:5000/dotnet/aspnet:8.0 
docker push localhost:5000/dotnet/aspnet:8.0 
docker image rm localhost:5000/dotnet/aspnet:8.0 
