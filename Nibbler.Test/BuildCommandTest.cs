...
public class BuildCommandTest
{
    ...
    [DataRow(new string[] {
        ...
        "-v",
        "--trace" })]
    public async Task BuilderCommand_Labels_CommaSeparated(string[] args) => await Run(args);
    ...
    [DataRow(new string[] {
        ...
        "--trace" })]
    [DataRow(new string[] {
        "--from-image", "registry.hub.docker.com/library/ubuntu:focal",
        "--to-image", "localhost:5000/ubuntu:focal",
        "--to-insecure",
        "-v" })]
    [DataRow(new string[] {
        "--from-image", "registry.hub.docker.com/library/ubuntu:jammy",
        "--to-image", "localhost:5000/ubuntu:jammy",
        "--to-insecure",
        "-v",
        "--trace"})]
    ...
    [DataRow(new string[] {
        "--from-image", "localhost:5000/dotnet/aspnet:9.0",
        "--to-images", "localhost:5000/test/nibbler-test:unittest,localhost:5000/test/nibbler-test:latest",
        "--insecure",
        "-v",
        "--trace" })]
